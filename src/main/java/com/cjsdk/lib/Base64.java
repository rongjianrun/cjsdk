...
public class Base64 {
    ...
    final private static Base64 base64 = new Base64();
...
//                L.error(Base64.class, e);
    ...
    public static byte[] decode(byte[] data) {
        ...
        try {
            base64.decode(data, 0, data.length, bOut);
        } catch (IOException e) {
    ...
    public static int decode(byte[] data, OutputStream out) {
        try {
            return base64.decode(data, 0, data.length, out);
        } catch (IOException e) {
            throw new RuntimeException("exception decoding base64 string: " + e);
        }
    }
    ...
    public int encode(byte[] data, OutputStream out) throws IOException {
